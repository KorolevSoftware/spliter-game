...
namespace Engine {
    ...
    void Graphics::setGuiBuffer(const uint8_t* data, uint32_t sizeofdata) {
        // Draw GUi
    ...
    void Graphics::drawCommand(uint32_t start, uint32_t vertexCount) {
        sg_draw(start, vertexCount, 1);
    }
